...
export OPENAI_BASE_URL=http://10.146.100.202:30003/v1
...
# start bonsai tree (like w8 for something)
alias w8="cbonsai -i -l"

# ls with access infos
alias ll="eza -l -g --icons"

# Replace ls with cool one
...
# To create tmux session for main workflow
dev() {
  ...
  # Attach and go to window 1 (nvim)
  tmux select-window -t "$session_name:1"
...
# Kubernetes
export KUBECONFIG="$HOME/kuber/new-test-kubeconfig:$HOME/kuber/dsh-tailscale.yaml"


# Proxy configugarion
export proxy=

# Initialize hooks for auto-venv
